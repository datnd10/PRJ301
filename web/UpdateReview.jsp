<%-- 
    ...
    Created on : Oct 24, 2023, 12:45:01 AM
    Author     : Dac Dat
--%>
                        ...
                        <div class="card-body">
                            <form id="reviewForm">
                                ...
                                <div class="form-group col-md-6 text-left mb-5">
                                    ...
                                    <div class="rating"> 
                                        <input type="radio" name="rating" value="5" id="5" ${review.star == 5 ? "checked" : ""}><label for="5">☆</label>
                                        <input type="radio" name="rating" value="4" id="4" ${review.star == 4 ? "checked" : ""}><label for="4">☆</label> 
                                        <input type="radio" name="rating" value="3" id="3" ${review.star == 3 ? "checked" : ""}><label for="3">☆</label>
                                        <input type="radio" name="rating" value="2" id="2" ${review.star == 2 ? "checked" : ""}><label for="2">☆</label>
                                        <input type="radio" name="rating" value="1" id="1" ${review.star == 1 ? "checked" : ""}><label for="1">☆</label>
                                    </div>
                                </div>
                                <div class="form-group col-md-12 text-left">
                                    <label for="description" style="font-weight: bold;display: block">Description</label>
                                    <textarea class="form-control" id="description" name="description" rows="4">${review.description}</textarea>
                                </div>
                                <div class="form-group col-md-12 text-left">
                                    ...
                                    <img  src="images/${review.image}" id="output" style="width: 100px;height: 100px;object-fit: cover"/>
                                </div>
                                <input type="text" class="form-control" id="image" name="image" hidden="">
                                <input type="text" class="form-control" id="createat" name="creatat" hidden="" value="${review.create_at}">
                                <input type="text" class="form-control" id="reviewId" name="reviewId" hidden="" value="${review.review_id}">
                                <input type="text" class="form-control" id="productColorId" name="productColorId" hidden="" value="${requestScope.productColorId}">
                                <input type="text" value="${review.image}" name="defaultImage" hidden="">
                                                    ...
                                                    switch (response) {
                                                        default :
                                                            Swal.fire({
                                                                ...
                                                                confirmButtonText: 'See your review',
